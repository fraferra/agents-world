...
A society's buildings root it: each one makes founding a colony less appealing, so settled towns send colonists mainly under real land pressure. A colony needs at least six pioneers and must leave at least twelve people at home. A band that has dwindled below five people, a year or more after its founding, joins the most promising band within 40 tiles that is larger and not at war with it. Allies, kin, trading partners, trust, buildings and size all count toward "most promising". The band brings its stores, and its people walk to their new home.
