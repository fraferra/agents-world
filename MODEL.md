...
6. **Spread and apply it.** Encounters can teach a design, and communities can adopt it. Adopted inventions affect actual production and social competition with diminishing returns and combined tradeoffs. A registry preserves identities and ancestry, while access to an idea still requires individual or community knowledge. People keep about 60 designs in mind and societies about 150 in use; once they exceed that by a tenth, the oldest are forgotten together.
...
Wars are named for what they are about: the War of a disputed region, the Coal War, a War of Independence, the Second Ashford–Kell War. Wars between countries are named for them: the War of the Ember Empire and the Kingdom of Oak.

**Countries, allies and great wars.** A war between countries involves every settlement of both. All members of each country join its side, and so does any settlement that joins either country while the war lasts. Every settlement on one side is at war with every settlement on the other: fighting breaks out wherever they meet, while distant members stay at war and on a war footing without being able to fight. If the settlement that led a side falls or empties, its country fights on under its capital or its largest remaining settlement. Beyond countries, allies with strong trust and tributaries may join either side, defenders more readily than attackers, up to three on a side. A war with five or more powers, counting each country once, becomes a Great War. Making peace between the two leading enemies ends the whole war. When one country wins, every settlement on the losing side pays reparations, its leader most.
